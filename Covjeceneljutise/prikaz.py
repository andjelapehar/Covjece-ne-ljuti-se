...
class Prikaz():
    ...
    def print_igraci_info(self):
        ...
        print("start igra s {} igraci:".format(len(self.igra.igraci)))
    ...
    def print_info_poslije_micanja(self):
        ...
        if self.igra.dopusten_pijuni:
            #inf kojeg pijuna je racunalo pomaklo
            ...
            if self.prompted_for_pijun:
                ...
                return
            #izbor racunala ako ima vise pijuna za micanje
            poruka += "{} mogući pijuni za micanje.".format(
                " ".join(pijuni_id))
            poruka += " " + poruka_o_premještanju
            #ako je "pojeden" pijun tijekom micanja
