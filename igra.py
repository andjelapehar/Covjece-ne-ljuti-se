...
class Prikaz(object):
    ...
    def pocetakIgre(self):
        odg=input("Želite li startati igru: ")
        if(odg=="da"):
            print("*" *20+ " Početak Igre " + "*"*20)
        else:
            print("*" *20+ " Možda drugi put " + "*"*20)
    def unosImena(self):
        while True:
            ...
            if ime.strip():
                print("*" *50)
                return ime.strip()
    def biranjeBoje(self):
        odg=input("Želite li odabrati boju: ")
        if(odg=="da"):
            while True:
                ...
                if boja.strip():
                    print("*" *50)
                    return boja.strip()
        else:print("*" *20+ " Možda drugi put " + "*"*20)
pi=Prikaz()
...
class Igra(object):
    def igranje(self):
        ...
        self.Kraj()
    def StartIgre(self):
        imeigre=self.prikaz.pocetakIgre() #1.1
        ime=self.prikaz.unosImena() #1.2
    def Biranjeboje(self):
        boja= self.prikaz.biranjeBoje() #2.1 i #2.2
